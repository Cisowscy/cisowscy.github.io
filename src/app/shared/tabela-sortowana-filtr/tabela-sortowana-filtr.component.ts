 ...
 */
@Component({
  selector: "app-tabela-sortowana-filtr",
  templateUrl: "./tabela-sortowana-filtr.component.html",
  styleUrls: ["./tabela-sortowana-filtr.component.scss"]
})
export class TabelaSortowanaFiltrComponent {
...
export class ExampleDatabase {
  ...
  private createNewUser() {
    const name =
      TEMAT_TAG[Math.round(Math.random() * (TEMAT_TAG.length - 1))] +
      " " +
      TEMAT_TAG[Math.round(Math.random() * (TEMAT_TAG.length - 1))].charAt(0) +
      ".";
    ...
    return {
      ...
      color: DOMINUJACY_KOLOR[Math.round(Math.random() * (DOMINUJACY_KOLOR.length - 1))]
    };
  }
}
